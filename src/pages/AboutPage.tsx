  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-16">
      ...
      <p className="mt-4 text-lg text-gray-700 leading-relaxed">
        Volley Monster organizes outdoor volleyball tournaments all summer long in the Olney, MD
        area. Whether you're competing at the Open level or just getting started, we have a division
        for you — and a great time guaranteed.
      </p>
      <p className="mt-4 text-gray-600 leading-relaxed">
        All events are held at our primary venue at 16915 Batchellors Forest Road, Olney, MD 20832.
        We also host the annual <strong>Carolyn Clark Volleyball Classic</strong> at Frederick
        Community College — a charity tournament supporting women pursuing careers in fire sciences.
      </p>
